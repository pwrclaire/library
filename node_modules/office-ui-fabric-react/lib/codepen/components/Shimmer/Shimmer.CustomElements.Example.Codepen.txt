let { Shimmer, ShimmerElementsGroup, ElemType, Fabric, mergeStyles, Fabric } = window.Fabric;
...
class ShimmerCustomElementsExample extends React.Component<{}, {}> {
  constructor(props: {}) {
    super(props);
  }
...
ReactDOM.render(<ShimmerCustomElementsExample />, document.getElementById('content'));
