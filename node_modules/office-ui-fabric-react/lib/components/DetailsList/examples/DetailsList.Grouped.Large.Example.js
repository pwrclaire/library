...
var DetailsListGroupedLargeExample = /** @class */ (function (_super) {
    ...
    DetailsListGroupedLargeExample.prototype.render = function () {
        return (React.createElement(DetailsList, { items: this._items, groups: this._groups, columns: this._columns, getGroupHeight: this._getGroupHeight, ariaLabelForSelectAllCheckbox: "Toggle selection for all items", ariaLabelForSelectionColumn: "Toggle selection" }));
    };
