...
define(["require", "exports", "tslib", "react", "office-ui-fabric-react/lib/DetailsList"], function (require, exports, tslib_1, React, DetailsList_1) {
    ...
    var DetailsListGroupedLargeExample = /** @class */ (function (_super) {
        ...
        DetailsListGroupedLargeExample.prototype.render = function () {
            return (React.createElement(DetailsList_1.DetailsList, { items: this._items, groups: this._groups, columns: this._columns, getGroupHeight: this._getGroupHeight, ariaLabelForSelectAllCheckbox: "Toggle selection for all items", ariaLabelForSelectionColumn: "Toggle selection" }));
        };
